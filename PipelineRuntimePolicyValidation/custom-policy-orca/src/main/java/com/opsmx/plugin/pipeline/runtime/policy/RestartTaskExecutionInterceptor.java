...
public class RestartTaskExecutionInterceptor implements TaskExecutionInterceptor {
    ...
    private ValidationManualjudgmentPipeline restartPipelineValidationTask;

    public RestartTaskExecutionInterceptor(ValidationManualjudgmentPipeline restartPipelineValidationTask) {
